...
sub check_sys {
    ...
    $state||='poststart';
    # had process running doesn't have to be 'bin/had' in ps -ef
    # Another circumstance should be ' had -onenode' in ps -ef
    $had_pids=$sys->proc_pids('bin/had');
    $had_pids=$sys->proc_pids(' had -onenode') if ($#{$had_pids}==-1);
...
sub is_onenode_running_sys {
    ...
    $had_pids=$sys->proc_pids(' had -onenode') if (!(@$had_pids));
    if (@$had_pids) {
...
package Proc::had60::Sol11sparc;
@Proc::had60::Sol11sparc::ISA = qw(Proc::had60::SunOS);
...
package Proc::had60::Sol11x64;
@Proc::had60::Sol11x64::ISA = qw(Proc::had60::Sol11sparc);
