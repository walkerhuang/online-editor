...
sub mp_sp_ru {
    ...
    if (($mpvers eq "6.0.3") || ($mpvers eq "6.0.5")) {
        $mpvers = "6.0.1";
    }
    return $mpvers;
}
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '5.1SP1RP3' => {
            #_START_SolSparc_5.1SP1RP3_PATCHES_DEF_
            'patch' => {
                '142629-16' => {
                    'pkgs'   => [qw(VRTSvxvm)],
                    'osvers' => [qw(5.9 5.10)],
            ...
            #_END_SolSparc_5.1SP1RP3_PATCHES_DEF_
        },
        '5.1SP1RP4' => {
            #_START_SolSparc_5.1SP1RP4_PATCHES_DEF_
            'patch' => {
                '142629-17' => {
                    'pkgs'   => [qw(VRTSvxvm)],
                    'osvers' => [qw(5.9 5.10)],
            ...
            #_END_SolSparc_5.1SP1RP4_PATCHES_DEF_
        },
        '6.0' => {
        ...
        '6.0.1' => {
            #_START_SolSparc_6.0.1_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxvm)],
                    'opkgs' => [qw(VRTSsfmh VRTSspt)],
                },
                'fs' => {
                    'name'  => 'Veritas File System',
                    'rpkgs' => [qw(VRTSfsadv VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxfs)],
                    'opkgs' => [qw(VRTSfssdk VRTSob VRTSsfmh VRTSspt)],
                },
                'sf' => {
                    'name'  => 'Veritas Storage Foundation',
                    'rpkgs' => [qw(VRTSaslapm VRTSfsadv VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTSdbed VRTSfssdk VRTSob VRTSodm VRTSsfmh VRTSspt)],
                },
                'sfcfsha' => {
                    'name'  => 'Veritas Storage Foundation for Cluster File System/HA',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSfsadv VRTSgab VRTSglm VRTSllt VRTSperl VRTSsfcpi601 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSgms VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSfsadv VRTSgab VRTSllt VRTSperl VRTSsfcpi601 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'sfrac' => {
                    'name'  => 'Veritas Storage Foundation for Oracle RAC',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSdbac VRTSdbed VRTSfsadv VRTSgab VRTSglm VRTSgms VRTSllt VRTSodm VRTSperl VRTSsfcpi601 VRTSvcs VRTSvcsag VRTSvcsea VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSfssdk VRTSob VRTSsfmh VRTSspt VRTSvbs)],
                },
                'sfsybasece' => {
                    'name'  => 'Veritas Storage Foundation for Sybase ASE CE',
                ...
                'svs' => {
                    'name'  => 'Symantec VirtualStore',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSfsadv VRTSgab VRTSglm VRTSllt VRTSperl VRTSsfcpi601 VRTSsfmh VRTSsvs VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSgms VRTSob VRTSodm VRTSspt VRTSvbs VRTSvcsea)],
                },
                'vcs' => {
                    'name'  => 'Veritas Cluster Server',
                    'rpkgs' => [qw(VRTSamf VRTSgab VRTSllt VRTSperl VRTSsfcpi601 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen)],
                    'opkgs' => [qw(VRTScps VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'vm' => {
                    'name'  => 'Veritas Volume Manager',
            ...
            #_END_SolSparc_6.0.1_PRODS_PKGS_DEF_
        },
        '6.0.3' => {
            #_START_SolSparc_6.0.3_PATCHES_DEF_
            'patch' => {
                '148481-02' => {
                    'pkgs'   => [qw(VRTSvxfs)],
                    'osvers' => [qw(5.10)],
                ...
                '149702-01' => {
                    'pkgs'   => [qw(VRTSsfcpi601)],
                    'osvers' => [qw(5.10)],
                },
            },
            #_END_SolSparc_6.0.3_PATCHES_DEF_
        },
        '6.0.5' => {
            #_START_SolSparc_6.0.5_PATCHES_DEF_
            'patch' => {
                '148481-03' => {
                    'pkgs'   => [qw(VRTSvxfs)],
                    'osvers' => [qw(5.10)],
            ...
            #_END_SolSparc_6.0.5_PATCHES_DEF_
        },
        '6.1' => {
            #_START_SolSparc_6.1_PATCHES_DEF_
            'prod' => {
                'sfrac' => {
                    'name' => 'Symantec Storage Foundation for Oracle RAC',
                    'rpkgs' => [qw(VRTSglm VRTSgab VRTSdbed VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTSdbac VRTSgms VRTScavf VRTSsfmh VRTSvcsea VRTSvxvm VRTSsfcpi61 VRTSvcswiz VRTSperl VRTSamf VRTSodm VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs )],
                    'opkgs' => [qw(VRTSspt VRTScps VRTSfssdk VRTSvbs VRTSob )],
                },
                'sfsybasece' => {
                    'name' => 'Symantec Storage Foundation for Sybase ASE CE',
                    'rpkgs' => [qw(VRTSglm VRTSgab VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTScavf VRTSsfmh VRTSvxvm VRTSsfcpi61 VRTSvcswiz VRTSperl VRTSamf VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs )],
                    'opkgs' => [qw(VRTSvcsea VRTSspt VRTSfssdk VRTSvbs VRTSob )],
                },
                'appha' => {
                    'name' => 'Symantec Application HA',
                    'rpkgs' => [qw(VRTSvcsea VRTSsfcpi61 VRTSvlic VRTSperl VRTSspt VRTSacclib VRTSvbs VRTSvcsag VRTSvcsvmw VRTSsfmh VRTSvcs )],
                    'opkgs' => [qw()],
                },
                'vm' => {
                    'name' => 'Symantec Volume Manager',
                    'rpkgs' => [qw(VRTSperl VRTSvxvm VRTSsfcpi61 VRTSaslapm VRTSvlic )],
                    'opkgs' => [qw(VRTSspt VRTSob VRTSsfmh )],
                },
                'sfcfsha' => {
                    'name' => 'Symantec Storage Foundation Cluster File System HA',
                    'rpkgs' => [qw(VRTSglm VRTSgab VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTScavf VRTSsfmh VRTSvxvm VRTSsfcpi61 VRTSvcswiz VRTSperl VRTSamf VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs )],
                    'opkgs' => [qw(VRTSvcsea VRTSob VRTSdbed VRTScps VRTSspt VRTSodm VRTSfssdk VRTSgms VRTSvbs )],
                },
                'sf' => {
                    'name' => 'Symantec Storage Foundation',
                    'rpkgs' => [qw(VRTSperl VRTSvxvm VRTSsfcpi61 VRTSaslapm VRTSvxfs VRTSvlic VRTSfsadv )],
                    'opkgs' => [qw(VRTSspt VRTSodm VRTSfssdk VRTSob VRTSdbed VRTSsfmh )],
                },
                'vcs' => {
                    'name' => 'Symantec Cluster Server',
                    'rpkgs' => [qw(VRTSsfcpi61 VRTSgab VRTSvcswiz VRTSvxfen VRTSvlic VRTSllt VRTSperl VRTSamf VRTSvcsag VRTSsfmh VRTSvcs )],
                    'opkgs' => [qw(VRTSvcsea VRTSspt VRTScps VRTSvbs )],
                },
                'fs' => {
                    'name' => 'Symantec File System',
                    'rpkgs' => [qw(VRTSperl VRTSsfcpi61 VRTSvxfs VRTSvlic VRTSfsadv )],
                    'opkgs' => [qw(VRTSspt VRTSfssdk VRTSob VRTSsfmh )],
                },
                'sfha' => {
                    'name' => 'Symantec Storage Foundation HA',
                    'rpkgs' => [qw(VRTSvxvm VRTSsfcpi61 VRTSgab VRTSvcswiz VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTSperl VRTSamf VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs VRTSsfmh )],
                    'opkgs' => [qw(VRTSvcsea VRTSob VRTSdbed VRTScps VRTSspt VRTSodm VRTSfssdk VRTSvbs )],
                },
                'dmp' => {
                    'name' => 'Symantec Dynamic Multi-Pathing',
                    'rpkgs' => [qw(VRTSperl VRTSvxvm VRTSsfcpi61 VRTSaslapm VRTSvlic )],
                    'opkgs' => [qw(VRTSspt VRTSsfmh )],
                },
            },
            #_END_SolSparc_6.1_PATCHES_DEF_
        },
    };
    return;
}
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '6.0.1' => {
            #_START_Sol11Sparc_6.0.1_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxvm)],
            ...
            #_END_Sol11Sparc_6.0.1_PRODS_PKGS_DEF_
        },
        '6.0.3' => {
            #_START_Sol11Sparc_6.0.3_PATCHES_DEF_
            'patch' => {
            },
            #_END_Sol11Sparc_6.0.3_PATCHES_DEF_
        },
        '6.0.5' => {
            #_START_Sol11Sparc_6.0.5_PATCHES_DEF_
            'patch' => {
            },
            #_END_Sol11Sparc_6.0.5_PATCHES_DEF_
        },
        '6.1' => {
            #_START_Sol11Sparc_6.1_PATCHES_DEF_
            'prod' => {
                'sfrac' => {
                    'name' => 'Symantec Storage Foundation for Oracle RAC',
                    'rpkgs' => [qw(VRTSglm VRTSgab VRTSdbed VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTSdbac VRTSgms VRTScavf VRTSsfmh VRTSvcsea VRTSvxvm VRTSsfcpi61 VRTSvcswiz VRTSperl VRTSamf VRTSodm VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs )],
                    'opkgs' => [qw(VRTSspt VRTScps VRTSfssdk VRTSvbs )],
                },
                'sfcfsha' => {
                    'name' => 'Symantec Storage Foundation Cluster File System HA',
                    'rpkgs' => [qw(VRTSglm VRTSgab VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTScavf VRTSsfmh VRTSvxvm VRTSsfcpi61 VRTSvcswiz VRTSperl VRTSamf VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs )],
                    'opkgs' => [qw(VRTSvcsea VRTSdbed VRTScps VRTSspt VRTSodm VRTSfssdk VRTSgms VRTSvbs )],
                },
                'vm' => {
                    'name' => 'Symantec Volume Manager',
                    'rpkgs' => [qw(VRTSperl VRTSvxvm VRTSsfcpi61 VRTSaslapm VRTSvlic )],
                ...
                'sf' => {
                    'name' => 'Symantec Storage Foundation',
                    'rpkgs' => [qw(VRTSperl VRTSvxvm VRTSsfcpi61 VRTSaslapm VRTSvxfs VRTSvlic VRTSfsadv )],
                    'opkgs' => [qw(VRTSspt VRTSodm VRTSfssdk VRTSdbed VRTSsfmh )],
                },
                'vcs' => {
                    'name' => 'Symantec Cluster Server',
                    'rpkgs' => [qw(VRTSsfcpi61 VRTSgab VRTSvxfen VRTSvlic VRTSvcswiz VRTSllt VRTSperl VRTSamf VRTSvcsag VRTSsfmh VRTSvcs )],
                    'opkgs' => [qw(VRTSvcsea VRTSspt VRTScps VRTSvbs )],
                },
                'fs' => {
                    'name' => 'Symantec File System',
                    'rpkgs' => [qw(VRTSperl VRTSsfcpi61 VRTSvxfs VRTSvlic VRTSfsadv )],
                    'opkgs' => [qw(VRTSspt VRTSfssdk VRTSsfmh )],
                },
                'sfha' => {
                    'name' => 'Symantec Storage Foundation HA',
                    'rpkgs' => [qw(VRTSvxvm VRTSsfcpi61 VRTSgab VRTSvxfs VRTSvxfen VRTSvlic VRTSvcswiz VRTSllt VRTSperl VRTSamf VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs VRTSsfmh )],
                    'opkgs' => [qw(VRTSvcsea VRTSspt VRTScps VRTSodm VRTSfssdk VRTSvbs VRTSdbed )],
                },
                'dmp' => {
                    'name' => 'Symantec Dynamic Multi-Pathing',
                    'rpkgs' => [qw(VRTSperl VRTSvxvm VRTSsfcpi61 VRTSaslapm VRTSvlic )],
            ...
            #_END_Sol11Sparc_6.1_PATCHES_DEF_
        },
    };
    return;
}
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '5.1SP1RP3' => {
            #_START_Solx64_5.1SP1RP3_PATCHES_DEF_
            'patch' => {
                '142630-16' => {
                    'pkgs'   => [qw(VRTSvxvm)],
                    'osvers' => [qw(5.10)],
            ...
            #_END_Solx64_5.1SP1RP3_PATCHES_DEF_
        },
        '5.1SP1RP4' => {
            #_START_Solx64_5.1SP1RP4_PATCHES_DEF_
            'patch' => {
                '142630-17' => {
                    'pkgs'   => [qw(VRTSvxvm)],
                    'osvers' => [qw(5.10)],
            ...
            #_END_Solx64_5.1SP1RP4_PATCHES_DEF_
        },
        '6.0' => {
        ...
        '6.0.1' => {
            #_START_Solx64_6.0.1_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxvm)],
                ...
                'fs' => {
                    'name'  => 'Veritas File System',
                    'rpkgs' => [qw(VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxfs)],
                    'opkgs' => [qw(VRTSfssdk VRTSob VRTSsfmh VRTSspt)],
                },
                'sf' => {
                    'name'  => 'Veritas Storage Foundation',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTSdbed VRTSfssdk VRTSob VRTSodm VRTSsfmh VRTSspt)],
                },
                'sfcfsha' => {
                    'name'  => 'Veritas Storage Foundation for Cluster File System/HA',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSgab VRTSglm VRTSllt VRTSperl VRTSsfcpi601 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSgms VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSgab VRTSllt VRTSperl VRTSsfcpi601 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'sfrac' => {
                    'name'  => 'Veritas Storage Foundation for Oracle RAC',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSdbac VRTSdbed VRTSgab VRTSglm VRTSgms VRTSllt VRTSodm VRTSperl VRTSsfcpi601 VRTSvcs VRTSvcsag VRTSvcsea VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSfssdk VRTSob VRTSsfmh VRTSspt VRTSvbs)],
                },
                'svs' => {
                    'name'  => 'Symantec VirtualStore',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSgab VRTSglm VRTSllt VRTSperl VRTSsfcpi601 VRTSsfmh VRTSsvs VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSgms VRTSob VRTSodm VRTSspt VRTSvbs VRTSvcsea)],
                },
                'vcs' => {
                    'name'  => 'Veritas Cluster Server',
            ...
            #_END_Solx64_6.0.1_PRODS_PKGS_DEF_
        },
        '6.0.3' => {
            #_START_Solx64_6.0.3_PATCHES_DEF_
            'patch' => {
                '148482-02' => {
                    'pkgs'   => [qw(VRTSvxfs)],
                    'osvers' => [qw(5.10)],
            ...
            #_END_Solx64_6.0.3_PATCHES_DEF_
        },
        '6.0.5' => {
            #_START_Solx64_6.0.5_PATCHES_DEF_
            'patch' => {
                '148482-03' => {
                    'pkgs'   => [qw(VRTSvxfs)],
                    'osvers' => [qw(5.10)],
            ...
            #_END_Solx64_6.0.5_PATCHES_DEF_
        },
    };
    return;
}
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '6.0.1' => {
            #_START_Sol11x64_6.0.1_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxvm)],
            ...
            #_END_Sol11x64_6.0.1_PRODS_PKGS_DEF_
        },
    };
    return;
}
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '5.1SP1RP2' => {
             #_START_HPUX1131_5.1SP1RP2_PATCHES_DEF_
            'patch' => {
                'PHCO_42318' => { 'pkgs' => [qw(VRTSsfmh)] },
                'PHCO_43070' => { 'pkgs' => [qw(VRTSdbed)] },
                'PHCO_42319' => { 'pkgs' => [qw(VRTSob)], 'supersedes' => [ qw(PHCO_42182) ] },
                'PHCO_42213' => { 'pkgs' => [qw(VRTSperl)] },
                'PHKL_43127' => { 'pkgs' => [qw(VRTSvxfs)] },
                'PHKL_43064' => { 'pkgs' => [qw(VRTSvxvm)] },
                'PHCO_43069' => { 'pkgs' => [qw(VRTSvxfen)] },
                'PHCO_43172' => { 'pkgs' => [qw(VRTSvxfs)] },
                'PHKL_42246' => { 'pkgs' => [qw(VRTSvxvm)] },
                'PHKL_42741' => { 'pkgs' => [qw(VRTSodm)] },
                'PHKL_43068' => { 'pkgs' => [qw(VRTSvxfen)] },
                'PHKL_42342' => { 'pkgs' => [qw(VRTSglm)] },
                'PVCO_03962' => { 'pkgs' => [qw(VRTSamf)] },
                'PVCO_03930' => { 'pkgs' => [qw(VRTScps)] },
                'PVCO_03958' => { 'pkgs' => [qw(VRTSvcs)] },
                'PVCO_03963' => { 'pkgs' => [qw(VRTScavf)] },
                'PVCO_03959' => { 'pkgs' => [qw(VRTSvcsag)] },
                'PVCO_03960' => { 'pkgs' => [qw(VRTSvcsea)] },
                'PHNE_43151' => { 'pkgs' => [qw(VRTSllt)] },
                'PHNE_43152' => { 'pkgs' => [qw(VRTSgab)] },
                'PVCO_03957' => { 'pkgs' => [qw(VRTSdbac)] },
            },
        },
        '5.1SP1RP3' => {
             #_START_HPUX1131_5.1SP1RP3_PATCHES_DEF_
            'patch' => {
                'PHCO_43669' => { 'pkgs' => [qw(VRTSperl)] },
                'PHCO_42318' => { 'pkgs' => [qw(VRTSsfmh)] },
                'PHCO_42320' => { 'pkgs' => [qw(VRTSob)] },
                'PHCO_43526' => { 'pkgs' => [qw(VRTSvxvm)] },
                'PHCO_43528' => { 'pkgs' => [qw(VRTSdbed)] },
                'PHCO_43531' => { 'pkgs' => [qw(VRTSvxfen)], 'supersedes' => [qw(PHCO_42254 PHCO_43069)] },
                'PHCO_43540' => { 'pkgs' => [qw(VRTSvxfs)] },
                'PHKL_42342' => { 'pkgs' => [qw(VRTSglm)] },
                'PHKL_43527' => { 'pkgs' => [qw(VRTSvxvm)] },
                'PHKL_43532' => { 'pkgs' => [qw(VRTSvxfen)], 'supersedes' => [qw(PHKL_42252 PHKL_43068)] },
                'PHKL_43538' => { 'pkgs' => [qw(VRTSodm)] },
                'PHKL_43539' => { 'pkgs' => [qw(VRTSvxfs)] },
                'PHNE_43152' => { 'pkgs' => [qw(VRTSgab)] },
                'PHNE_43529' => { 'pkgs' => [qw(VRTSllt)], 'supersedes' => [qw(PHNE_43151)] },
                'PVCO_03930' => { 'pkgs' => [qw(VRTScps)] },
                'PVCO_03997' => { 'pkgs' => [qw(VRTScavf)] },
                'PVCO_03990' => { 'pkgs' => [qw(VRTSdbac)] },
                'PVCO_03991' => { 'pkgs' => [qw(VRTSvcs)], 'supersedes' => [qw(PVCO_03931 PVCO_03958)] },
                'PVCO_03992' => { 'pkgs' => [qw(VRTSvcsea)], 'supersedes' => [qw(PVCO_03934 PVCO_03960)] },
                'PVCO_03993' => { 'pkgs' => [qw(VRTSvcsag)], 'supersedes' => [qw(PVCO_03933 PVCO_03959)] },
                'PVCO_03994' => { 'pkgs' => [qw(VRTSamf)], 'supersedes' => [qw(PVCO_03929 PVCO_03962)] },
            },
            #_END_HPUX1131_5.1SP1RP3_PATCHES_DEF_
        },
        '6.0' => {
        ...
        '6.0.1' => {
            #_START_HPUX1131_6.0.1_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxvm)],
            ...
            #_END_HPUX1131_6.0.1_PRODS_PKGS_DEF_
        },
        '6.0.3' => {
            #_START_HPUX1131_6.0.3_PATCHES_DEF_
            'patch' => {
                'PVCO_03970' => {
                    'pkgs'   => [ qw(VRTSsfcpi601) ],
                },
            ...
            #_END_HPUX1131_6.0.3_PATCHES_DEF_
        },
        '6.0.5' => {
            #_START_HPUX1131_6.0.5_PATCHES_DEF_
            'patch' => {
                'PVCO_04032' => {
                    'pkgs'   => [ qw(VRTScavf) ],
                },
            ...
            #_END_HPUX1131_6.0.5_PATCHES_DEF_
        },
    };
    return;
}
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '6.0.1' => {
            #_START_AIX_6.0.1_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSveki VRTSvlic VRTSvxvm)],
                    'opkgs' => [qw(VRTSsfmh VRTSspt)],
                },
                'fs' => {
                    'name'  => 'Veritas File System',
                    'rpkgs' => [qw(VRTSfsadv VRTSperl VRTSsfcpi601 VRTSveki VRTSvlic VRTSvxfs)],
                    'opkgs' => [qw(VRTSfssdk VRTSob VRTSsfmh VRTSspt)],
                },
                'sf' => {
                    'name'  => 'Veritas Storage Foundation',
                    'rpkgs' => [qw(VRTSaslapm VRTSfsadv VRTSperl VRTSsfcpi601 VRTSveki VRTSvlic VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTSdbed VRTSfssdk VRTSob VRTSodm VRTSsfmh VRTSspt)],
                },
                'sfcfsha' => {
                    'name'  => 'Veritas Storage Foundation for Cluster File System/HA',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSfsadv VRTSgab VRTSglm VRTSllt VRTSperl VRTSsfcpi601 VRTSvcs VRTSvcsag VRTSveki VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSgms VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSfsadv VRTSgab VRTSllt VRTSperl VRTSsfcpi601 VRTSvcs VRTSvcsag VRTSveki VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'sfrac' => {
                    'name'  => 'Veritas Storage Foundation for Oracle RAC',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSdbac VRTSdbed VRTSfsadv VRTSgab VRTSglm VRTSgms VRTSllt VRTSodm VRTSperl VRTSsfcpi601 VRTSvcs VRTSvcsag VRTSvcsea VRTSveki VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSfssdk VRTSob VRTSsfmh VRTSspt VRTSvbs)],
                },
                'vcs' => {
                    'name'  => 'Veritas Cluster Server',
                    'rpkgs' => [qw(VRTSamf VRTSgab VRTSllt VRTSperl VRTSsfcpi601 VRTSvcs VRTSvcsag VRTSveki VRTSvlic VRTSvxfen)],
                    'opkgs' => [qw(VRTScps VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'vm' => {
                    'name'  => 'Veritas Volume Manager',
            ...
            #_END_AIX_6.0.1_PRODS_PKGS_DEF_
        },
        '6.1' => {
            #_START_AIX_6.1_PRODS_PKGS_DEF_
            'prod' => {
                'sfrac' => {
                    'name' => 'Symantec Storage Foundation for Oracle RAC',
                    'rpkgs' => [qw(VRTSglm VRTSveki VRTSgab VRTSdbed VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTSdbac VRTSgms VRTScavf VRTSsfmh VRTSvcsea VRTSvxvm VRTSsfcpi61 VRTSvcswiz VRTSperl VRTSamf VRTSodm VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs )],
                    'opkgs' => [qw(VRTSspt VRTScps VRTSfssdk VRTSvbs VRTSob )],
                },
                'appha' => {
                    'name' => 'Symantec Application HA',
                ...
                'sfcfsha' => {
                    'name' => 'Symantec Storage Foundation Cluster File System HA',
                    'rpkgs' => [qw(VRTSglm VRTSveki VRTSgab VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTScavf VRTSsfmh VRTSvxvm VRTSsfcpi61 VRTSvcswiz VRTSperl VRTSamf VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs )],
                    'opkgs' => [qw(VRTSvcsea VRTSob VRTSdbed VRTScps VRTSspt VRTSodm VRTSfssdk VRTSgms VRTSvbs )],
                },
                'vm' => {
                    'name' => 'Symantec Volume Manager',
                    'rpkgs' => [qw(VRTSperl VRTSvxvm VRTSveki VRTSsfcpi61 VRTSaslapm VRTSvlic )],
                    'opkgs' => [qw(VRTSspt VRTSob VRTSsfmh )],
                },
                'sf' => {
                    'name' => 'Symantec Storage Foundation',
                    'rpkgs' => [qw(VRTSperl VRTSvxvm VRTSveki VRTSsfcpi61 VRTSaslapm VRTSvxfs VRTSvlic VRTSfsadv )],
                    'opkgs' => [qw(VRTSspt VRTSodm VRTSfssdk VRTSob VRTSdbed VRTSsfmh )],
                },
                'vcs' => {
                    'name' => 'Symantec Cluster Server',
                    'rpkgs' => [qw(VRTSveki VRTSsfcpi61 VRTSgab VRTSvcswiz VRTSvxfen VRTSvlic VRTSllt VRTSperl VRTSamf VRTSvcsag VRTSsfmh VRTSvcs )],
                    'opkgs' => [qw(VRTSvcsea VRTSspt VRTScps VRTSvbs )],
                },
                'sfha' => {
                    'name' => 'Symantec Storage Foundation HA',
                    'rpkgs' => [qw(VRTSveki VRTSgab VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTSsfmh VRTSvxvm VRTSsfcpi61 VRTSvcswiz VRTSperl VRTSamf VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs )],
                    'opkgs' => [qw(VRTSvcsea VRTSob VRTSdbed VRTScps VRTSspt VRTSodm VRTSfssdk VRTSvbs )],
                },
                'fs' => {
                    'name' => 'Symantec File System',
                    'rpkgs' => [qw(VRTSperl VRTSveki VRTSsfcpi61 VRTSvxfs VRTSvlic VRTSfsadv )],
                    'opkgs' => [qw(VRTSspt VRTSfssdk VRTSob VRTSsfmh )],
                },
                'dmp' => {
                    'name' => 'Symantec Dynamic Multi-Pathing',
    ...
    if ($checksf) {
        ...
        if ($sys->{pkgvers}{VRTSvxvm} && $sys->{pkgvers}{VRTSvxfs}) {
            ...
            if ($rel->vcs_installed($sys) && !EDRu::compvers($sys->{pkgvers}{VRTSvcs}, $sys->{pkgvers}{VRTSvxvm}, 3)) {
                $checkvcs = 0;
                $checkat = 0 if ($rel->get_major_vers($sys->{pkgvers}{VRTSvcs}) < 6.0);
                if ($sys->{pkgvers}{VRTSvcsag} eq '6.0.200.000') {
                    $sys->{iprod}{sfha}{imainpkg} = 'VRTSvxvm VRTSvxfs VRTSvcs VRTSvcsag';
                }else {
                    $sys->{iprod}{sfha}{imainpkg} = 'VRTSvxvm VRTSvxfs VRTSvcs';
                }
            } else {
                #add an exception here for 6.0.2 on sles11
                if ($sys->{padv} eq 'SLES11x8664' && $sys->{pkgvers}{VRTSvcs} eq '6.0.100.000' && $sys->{pkgvers}{VRTSvxvm} eq '6.0.100.100' ) {
                    $checkvcs = 0;
                    $sys->{iprod}{sfha}{imainpkg} = 'VRTSvxvm VRTSvxfs VRTSvcs VRTSvcsag';
                }else{
                    $sys->{iprod}{sf}{imainpkg} = 'VRTSvxvm VRTSvxfs';
...
package Rel::UXRT601::RHEL4x8664;
...
package Rel::UXRT601::RHEL5x8664;
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '6.0.1' => {
            #_START_RHEL5x8664_6.0.1_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxvm)],
            ...
            #_END_RHEL5x8664_6.0.1_PRODS_PKGS_DEF_
        },
        '6.0.2' => {
            #_START_RHEL5x8664_6.0.2_PRODS_PKGS_DEF_
            'prod' => {
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability For VMware',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSfsadv VRTSgab VRTSllt VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSlvmconv VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsdr VRTSvcsea VRTSvcsvmw)],
                },
                'vcs' => {
                    'name'  => 'Veritas Cluster Server For VMware',
                    'rpkgs' => [qw(VRTSamf VRTSgab VRTSllt VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen)],
                    'opkgs' => [qw(VRTScps VRTSsfmh VRTSspt VRTSvbs VRTSvcsdr VRTSvcsea VRTSvcsvmw)],
                },
            },
            #_END_RHEL5x8664_6.0.2_PRODS_PKGS_DEF_
        },
        '6.0.5' => {
            # We have no choice but redefine 6.0.5 package list because VRTSvcsvmw is added into 6.0.5 for SFHA/VCS
            # We don't care if VRTSvcsvmw is installed for SFCFSHA/SFSYBASECE/SFRAC.
            #_START_RHEL5x8664_6.0.5_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxvm)],
                ...
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSfsadv VRTSgab VRTSllt VRTSperl VRTSsfcpi601 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm VRTSvcsvmw)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSlvmconv VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsdr VRTSvcsea)],
                },
                'sfrac' => {
                    'name'  => 'Veritas Storage Foundation for Oracle RAC',
                ...
                'vcs' => {
                    'name'  => 'Veritas Cluster Server',
                    'rpkgs' => [qw(VRTSamf VRTSgab VRTSllt VRTSperl VRTSsfcpi601 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvcsvmw)],
                    'opkgs' => [qw(VRTScps VRTSsfmh VRTSspt VRTSvbs VRTSvcsdr VRTSvcsea)],
                },
                'vm' => {
                    'name'  => 'Veritas Volume Manager',
            ...
            #_END_RHEL5x8664_6.0.5_PRODS_PKGS_DEF_
        },
        '6.1' => {
            #_START_RHEL5x8664_6.1_PRODS_PKGS_DEF_
            'prod' => {
                'sfrac' => {
                    'name' => 'Symantec Storage Foundation for Oracle RAC',
                    'rpkgs' => [qw(VRTSglm VRTSgab VRTSdbed VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTSdbac VRTSgms VRTScavf VRTSsfmh VRTSvcsea VRTSvxvm VRTSsfcpi61 VRTSvcswiz VRTSperl VRTSamf VRTSodm VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs )],
                    'opkgs' => [qw(VRTSspt VRTScps VRTSvcsdr VRTSlvmconv VRTSfssdk VRTSvbs VRTSob )],
                },
                'appha' => {
                    'name' => 'Symantec Application HA',
                    'rpkgs' => [qw(VRTSvlic VRTSspt VRTSsapwebas71 VRTSsapcms VRTSmysql VRTSmq6 VRTSvcsvmw VRTSsaplc VRTSjboss VRTSsfmh VRTSwls VRTSvcsea VRTSsfcpi61 VRTSvcswas VRTSperl VRTSvbs VRTSacclib VRTSsapnw04 VRTSvcsag VRTSvcs )],
                    'opkgs' => [qw()],
                },
                'sfcfsha' => {
                    'name' => 'Symantec Storage Foundation Cluster File System HA',
                    'rpkgs' => [qw(VRTSglm VRTSgab VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTScavf VRTSsfmh VRTSvxvm VRTSsfcpi61 VRTSvcswiz VRTSperl VRTSamf VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs )],
                    'opkgs' => [qw(VRTSvcsea VRTSvcsdr VRTSob VRTSdbed VRTScps VRTSspt VRTSodm VRTSlvmconv VRTSfssdk VRTSvbs VRTSgms )],
                },
                'vm' => {
                    'name' => 'Symantec Volume Manager',
                    'rpkgs' => [qw(VRTSperl VRTSvxvm VRTSsfcpi61 VRTSaslapm VRTSvlic )],
                    'opkgs' => [qw(VRTSspt VRTSlvmconv VRTSob VRTSsfmh )],
                },
                'sf' => {
                    'name' => 'Symantec Storage Foundation',
                    'rpkgs' => [qw(VRTSperl VRTSvxvm VRTSsfcpi61 VRTSaslapm VRTSvxfs VRTSvlic VRTSfsadv )],
                    'opkgs' => [qw(VRTSspt VRTSodm VRTSlvmconv VRTSfssdk VRTSob VRTSdbed VRTSsfmh )],
                },
                'vcs' => {
                    'name' => 'Symantec Cluster Server',
                    'rpkgs' => [qw(VRTSsfcpi61 VRTSgab VRTSvcswiz VRTSvxfen VRTSvlic VRTSllt VRTSperl VRTSamf VRTSvcsag VRTSsfmh VRTSvcs )],
                    'opkgs' => [qw(VRTSvcsea VRTSspt VRTScps VRTSvcsdr VRTSvbs )],
                },
                'fs' => {
                    'name' => 'Symantec File System',
                    'rpkgs' => [qw(VRTSperl VRTSsfcpi61 VRTSvxfs VRTSvlic VRTSfsadv )],
                ...
                'sfha' => {
                    'name' => 'Symantec Storage Foundation HA',
                    'rpkgs' => [qw(VRTSvxvm VRTSsfcpi61 VRTSgab VRTSvcswiz VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTSperl VRTSamf VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs VRTSsfmh )],
                    'opkgs' => [qw(VRTSvcsea VRTSvcsdr VRTSob VRTSdbed VRTScps VRTSspt VRTSodm VRTSlvmconv VRTSfssdk VRTSvbs )],
                },
                'dmp' => {
                    'name' => 'Symantec Dynamic Multi-Pathing',
                    'rpkgs' => [qw(VRTSperl VRTSvxvm VRTSsfcpi61 VRTSaslapm VRTSvlic )],
            ...
            #_END_RHEL5x8664_6.1_PRODS_PKGS_DEF_
        },
    };
    return;
}

package Rel::UXRT601::RHEL5ppc64;
...
package Rel::UXRT601::RHEL6x8664;
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '6.0.1' => {
            #_START_RHEL6x8664_6.0.1_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxvm)],
            ...
            #_END_RHEL6x8664_6.0.1_PRODS_PKGS_DEF_
        },
        '6.0.2' => {
            #_START_RHEL6x8664_6.0.2_PRODS_PKGS_DEF_
            'prod' => {
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability For VMware',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSfsadv VRTSgab VRTSllt VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
            ...
            #_END_RHEL6x8664_6.0.2_PRODS_PKGS_DEF_
        },
        '6.0.4' => {
            #_START_RHEL6x8664_6.0.4_PRODS_PKGS_DEF_
            'prod' => {
                'vcs' => {
                    'name' => 'Veritas Cluster Server',
                    'rpkgs' => [qw(VRTSperl VRTSvlic VRTSllt VRTSgab VRTSvxfen VRTSamf VRTSvcs VRTSvcsag VRTSvcsvmw VRTSsfcpi604)],
                    'opkgs' => [qw(VRTSspt VRTScps VRTSvcsdr VRTSvcsea VRTSacclib VRTSmq6 VRTSsapwebas71 VRTSsfmh VRTSvbs)],
                },
            },
            #_END_RHEL6x8664_6.0.4_PRODS_PKGS_DEF_
        },
        '6.0.5' => {
            #_START_RHEL6x8664_6.0.5_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxvm)],
            ...
            #_END_RHEL6x8664_6.0.5_PRODS_PKGS_DEF_
        },
        '6.1' => {
            #_START_RHEL6x8664_6.1_PRODS_PKGS_DEF_
            'prod' => {
                'sfrac' => {
                    'name' => 'Symantec Storage Foundation for Oracle RAC',
                    'rpkgs' => [qw(VRTSglm VRTSgab VRTSdbed VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTSdbac VRTSgms VRTScavf VRTSsfmh VRTSvcsea VRTSvxvm VRTSsfcpi61 VRTSvcswiz VRTSperl VRTSamf VRTSodm VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs )],
            ...
            #_END_RHEL6x8664_6.1_PRODS_PKGS_DEF_
        },
    };
    return;
}

package Rel::UXRT601::RHEL6ppc64;
...
package Rel::UXRT601::SLES9x8664;
...
package Rel::UXRT601::SLES10x8664;
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '6.0.1' => {
            #_START_SLES10x8664_6.0.1_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxvm)],
            ...
            #_END_SLES10x8664_6.0.1_PRODS_PKGS_DEF_
        },
        '6.0.2' => {
            #_START_SLES10x8664_6.0.2_PRODS_PKGS_DEF_
            'prod' => {
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability For VMware',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSfsadv VRTSgab VRTSllt VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
            ...
            #_END_SLES10x8664_6.0.2_PRODS_PKGS_DEF_
        },
        '6.0.5' => {
            #_START_SLES10x8664_6.0.5_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxvm)],
            ...
            #_END_SLES10x8664_6.0.5_PRODS_PKGS_DEF_
        },
    };
    return;
}
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '6.0.1' => {
            #_START_SLES11x8664_6.0.1_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxvm)],
            ...
            #_END_SLES11x8664_6.0.1_PRODS_PKGS_DEF_
        },
        '6.0.2' => {
            #_START_SLES11x8664_6.0.2_PRODS_PKGS_DEF_
            'prod' => {
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability For VMware',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSfsadv VRTSgab VRTSllt VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
            ...
            #_END_SLES11x8664_6.0.2_PRODS_PKGS_DEF_
        },
        '6.0.4' => {
            #_START_SLES11x8664_6.0.4_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi604 VRTSvlic VRTSvxvm)],
                    'opkgs' => [qw(VRTSsfmh VRTSspt)],
                },
                'fs' => {
                    'name'  => 'Veritas File System',
                    'rpkgs' => [qw(VRTSfsadv VRTSperl VRTSsfcpi604 VRTSvlic VRTSvxfs)],
                    'opkgs' => [qw(VRTSfssdk VRTSob VRTSsfmh VRTSspt)],
                },
                'sf' => {
                    'name'  => 'Veritas Storage Foundation',
                    'rpkgs' => [qw(VRTSaslapm VRTSfsadv VRTSperl VRTSsfcpi604 VRTSvlic VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTSdbed VRTSfssdk VRTSlvmconv VRTSob VRTSodm VRTSsfmh VRTSspt)],
                },
                'sfcfsha' => {
                    'name'  => 'Veritas Storage Foundation for Cluster File System/HA',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSfsadv VRTSgab VRTSglm VRTSllt VRTSperl VRTSsfcpi604 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSgms VRTSlvmconv VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsdr VRTSvcsea)],
                },
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSfsadv VRTSgab VRTSllt VRTSperl VRTSsfcpi604 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSlvmconv VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsdr VRTSvcsea)],
                },
                'sfrac' => {
                    'name'  => 'Veritas Storage Foundation for Oracle RAC',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSdbac VRTSdbed VRTSfsadv VRTSgab VRTSglm VRTSgms VRTSllt VRTSodm VRTSperl VRTSsfcpi604 VRTSvcs VRTSvcsag VRTSvcsea VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSfssdk VRTSlvmconv VRTSob VRTSsfmh VRTSspt VRTSvbs VRTSvcsdr)],
                },
                'sfsybasece' => {
                    'name'  => 'Veritas Storage Foundation for Sybase ASE CE',
                ...
                'svs' => {
                    'name'  => 'Symantec VirtualStore',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSfsadv VRTSgab VRTSglm VRTSllt VRTSperl VRTSsfcpi604 VRTSsfmh VRTSsvs VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSgms VRTSlvmconv VRTSob VRTSodm VRTSspt VRTSvbs VRTSvcsdr VRTSvcsea)],
                },
                'vcs' => {
                    'name'  => 'Veritas Cluster Server',
                    'rpkgs' => [qw(VRTSamf VRTSgab VRTSllt VRTSperl VRTSsfcpi604 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen)],
                    'opkgs' => [qw(VRTScps VRTSsfmh VRTSspt VRTSvbs VRTSvcsdr VRTSvcsea)],
                },
                'vm' => {
                    'name'  => 'Veritas Volume Manager',
            ...
            #_END_SLES11x8664_6.0.4_PRODS_PKGS_DEF_
        },
        '6.0.5' => {
            #_START_SLES11x8664_6.0.5_PRODS_PKGS_DEF_
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi601 VRTSvlic VRTSvxvm)],
            ...
            #_END_SLES11x8664_6.0.5_PRODS_PKGS_DEF_
        },
        '6.1' => {
            #_START_SLES11x8664_6.1_PRODS_PKGS_DEF_
            'prod' => {
                'sfrac' => {
                    'name' => 'Symantec Storage Foundation for Oracle RAC',
                    'rpkgs' => [qw(VRTSglm VRTSgab VRTSdbed VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTSdbac VRTSgms VRTScavf VRTSsfmh VRTSvcsea VRTSvxvm VRTSsfcpi61 VRTSvcswiz VRTSperl VRTSamf VRTSodm VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs )],
                ...
                'sfsybasece' => {
                    'name' => 'Symantec Storage Foundation for Sybase ASE CE',
                    'rpkgs' => [qw(VRTSglm VRTSgab VRTSvxfs VRTSvxfen VRTSvlic VRTSllt VRTScavf VRTSsfmh VRTSvxvm VRTSsfcpi61 VRTSvcswiz VRTSperl VRTSamf VRTSaslapm VRTSvcsag VRTSfsadv VRTSvcs )],
                    'opkgs' => [qw(VRTSvcsea VRTSspt VRTSvcsdr VRTSlvmconv VRTSfssdk VRTSvbs VRTSob )],
                },
                'appha' => {
                    'name' => 'Symantec Application HA',
                    'rpkgs' => [qw(VRTSvlic VRTSspt VRTSsapwebas71 VRTSsapcms VRTSmysql VRTSmq6 VRTSvcsvmw VRTSsaplc VRTSjboss VRTSsfmh VRTSwls VRTSvcsea VRTSsfcpi61 VRTSvcswas VRTSperl VRTSvbs VRTSacclib VRTSsapnw04 VRTSvcsag VRTSvcs )],
            ...
            #_END_SLES11x8664_6.1_PRODS_PKGS_DEF_
        },
...
package Rel::UXRT601::SLES10ppc64;
...
package Rel::UXRT601::SLES11ppc64;
