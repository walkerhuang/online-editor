...
package Rel::UXRT60SP1::Common;
@Rel::UXRT60SP1::Common::ISA = qw(Rel);
...
sub init_common {
    ...
    $rel->{basevers}='6.0';
    $rel->{gavers}='6.0';
    $rel->{titlevers}='6.0 SP1';
    $rel->{nopatches}=1;
    $rel->{license_ver}="6.0";
    $rel->{keyless_license_ver}="6.0SP1";
    ...
    $rel->{allpkgs}=[ qw(VRTSperl514 VRTSvlic32 VRTSsfcpi60SP1 VRTSspt60) ];
    $rel->{minpkgs}=[ qw(VRTSperl514 VRTSvlic32 VRTSsfcpi60SP1) ];
    $rel->{recpkgs}=[ qw(VRTSperl514 VRTSvlic32 VRTSsfcpi60SP1 VRTSspt60) ];
    $rel->{cpipkg}='VRTSsfcpi60SP1';
    ...
    $rel->{installonupgradepkgs}=[ qw(VRTSsfcpi60SP1) ];
...
sub init_args {
    ...
    $rel->{arguments} = $arguments = {
        ...
        'jumpstart' => {
            ...
            'handler' => \&Rel::UXRT60SP1::Common::process_jumpstart_arg,
        },
        'flash_archive' => {
            ...
            'handler' => \&Rel::UXRT60SP1::Common::process_flash_archive_arg,
        },
        'ai' => {
            ...
            'handler' => \&Rel::UXRT60SP1::Common::process_ai_arg,
        },
        'kickstart' => {
            ...
            'handler' => \&Rel::UXRT60SP1::Common::process_kickstart_arg,
        },
        'yumgroupxml' => {
            ...
            'handler' => \&Rel::UXRT60SP1::Common::process_yumgroupxml_arg,
        },
        'nim' => {
            ...
            'handler' => \&Rel::UXRT60SP1::Common::process_nim_arg,
        },

        # UXRT60SP1 option args
        'ignite' => {
            ...
            'handler' => \&Rel::UXRT60SP1::Common::process_ignite_arg,
        },
        ...
        'security' => {
            ...
            'handler' => \&Rel::UXRT60SP1::Common::process_security_arg,
        },
        'securityonenode' => {
        ...
        'fencing' => {
            ...
            'handler' => \&Rel::UXRT60SP1::Common::process_fencing_arg,
        },
        'configcps' => {
        ...
        'addnode' => {
            ...
            'handler' => \&Rel::UXRT60SP1::Common::process_addnode_arg,
        },
        'upgrade_kernelpkgs' => {
            'description' => Msg::new("The -upgrade_kernelpkgs option has been renamed to -rollingupgrade_phase1"),
            'handler' => \&Rel::UXRT60SP1::Common::process_ru_arg,
        },
    ...
    if ($way == 0) {
        ...
        while (($sysname,$sglist) = each %$failoversg_hash) {
            for $sg(@{$sglist}) {
                ...
                @sgarr=@{EDRu::arrdel(\@sgarr,($sysname))};
        ...
        for $sg(keys %$sgtargethash) {
            if($sgtargethash->{$sg}) {
                $msg=Msg::new("Failover service group $sg will be swithed to $sgtargethash->{$sg}");
            } else {
                $msg=Msg::new("Failover service group $sg will not be swithed because there is no system to failover on.");
            }
            $msg->print();
            $webmsg .= "$msg->{msg}\\n";
        }
...
sub ignite {
    ...
    my ($obsoleted_bundles,$obsoleted_bundled_pkgs,$obsoleted_note,$equal_prod);
    ...
    if (EDR::cmdexit()) {
        ...
        # add post_load_cmd = "/opt/VRTS/install/bin/UXRT60SP1/add_install_scripts" in core_media_cfg
        ...
        for my $line (@conts) {
            if ($line=~/sd_software_list/) {
                $filecont.="    ";
                $filecont.="post_load_cmd = \"/opt/VRTS/install/bin/UXRT60SP1/add_install_scripts\"\n";
            }
            $filecont.=$line."\n";
        }
...
package Rel::UXRT60SP1::AIX;
@Rel::UXRT60SP1::AIX::ISA = qw(Rel::UXRT60SP1::Common);
...
package Rel::UXRT60SP1::HPUX;
@Rel::UXRT60SP1::HPUX::ISA = qw(Rel::UXRT60SP1::Common);
...
package Rel::UXRT60SP1::HPUX1131;
@Rel::UXRT60SP1::HPUX1131::ISA = qw(Rel::UXRT60SP1::HPUX);
...
sub init_padv {
    ...
    $rel->{pkgsspace}=<<"_PKGSPACE_";
VRTSamf:691,1557,0,7
VRTSaslapm:0,3934,0,1185
VRTScavf:819,65,0,7
VRTScps:51489,0,0,2
VRTSdbac:3824,1774,0,497
VRTSdbed:212410,0,0,5
VRTSfsadv:32504,0,0,3
VRTSfssdk:8444,0,0,0
VRTSgab:217,2130,0,193
VRTSglm:1,1126,0,317
VRTSgms:0,307,0,2
VRTSllt:910,1314,0,799
VRTSob:126569,0,0,201
VRTSodm:6773,809,0,939
VRTSperl:175846,0,0,0
VRTSsfcpi60SP1:4842,0,0,0
VRTSsfmh:154154,0,0,0
VRTSspt:32689,0,0,0
VRTSvbs:112753,0,0,1
VRTSvcs:251802,10243,0,248
VRTSvcsag:5858,1,0,58
VRTSvcsea:17009,0,0,52
VRTSvlic:114,3774,0,3887
VRTSvxfen:1210,1712,0,552
VRTSvxfs:9641,93543,0,61242
VRTSvxvm:38037,333204,0,310931
_PKGSPACE_
    return;
}

package Rel::UXRT60SP1::Linux;
@Rel::UXRT60SP1::Linux::ISA = qw(Rel::UXRT60SP1::Common);
...
package Rel::UXRT60SP1::RHEL5x8664;
@Rel::UXRT60SP1::RHEL5x8664::ISA = qw(Rel::UXRT60SP1::Linux);
...
package Rel::UXRT60SP1::RHEL5ppc64;
@Rel::UXRT60SP1::RHEL5ppc64::ISA = qw(Rel::UXRT60SP1::Linux);
...
package Rel::UXRT60SP1::RHEL6x8664;
@Rel::UXRT60SP1::RHEL6x8664::ISA = qw(Rel::UXRT60SP1::Linux);
...
package Rel::UXRT60SP1::RHEL6ppc64;
@Rel::UXRT60SP1::RHEL6ppc64::ISA = qw(Rel::UXRT60SP1::Linux);
...
package Rel::UXRT60SP1::SLES10x8664;
@Rel::UXRT60SP1::SLES10x8664::ISA = qw(Rel::UXRT60SP1::Linux);
...
package Rel::UXRT60SP1::SLES10ppc64;
@Rel::UXRT60SP1::SLES10ppc64::ISA = qw(Rel::UXRT60SP1::Linux);
...
package Rel::UXRT60SP1::SLES11x8664;
@Rel::UXRT60SP1::SLES11x8664::ISA = qw(Rel::UXRT60SP1::Linux);
...
package Rel::UXRT60SP1::SLES11ppc64;
@Rel::UXRT60SP1::SLES11ppc64::ISA = qw(Rel::UXRT60SP1::Linux);
...
package Rel::UXRT60SP1::SunOS;
@Rel::UXRT60SP1::SunOS::ISA = qw(Rel::UXRT60SP1::Common);

sub init_plat {
    my ($rel) = @_;

    $rel->{driververs}='6.0SP1';
...
package Rel::UXRT60SP1::SolSparc;
@Rel::UXRT60SP1::SolSparc::ISA = qw(Rel::UXRT60SP1::SunOS);
...
package Rel::UXRT60SP1::Solx64;
@Rel::UXRT60SP1::Solx64::ISA = qw(Rel::UXRT60SP1::SunOS);
...
package Rel::UXRT60SP1::Sol11sparc;
@Rel::UXRT60SP1::Sol11sparc::ISA = qw(Rel::UXRT60SP1::SunOS);
...
sub preremove_sys {
    ...
    if (!$sys->{sru_level} && EDRu::inarr('VRTSvlic32', @{$sys->{uninstallpkgs}})) {
        $sys->cmd("_cmd_rm -rf /etc/vx/vxesd /etc/vx/vold_* 2>/dev/null");
    }
    return 1;
}

package Rel::UXRT60SP1::Sol11x64;
@Rel::UXRT60SP1::Sol11x64::ISA = qw(Rel::UXRT60SP1::Sol11sparc);
