...
sub init_plat {
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        ...
        VRTSpbx VRTSicsco VRTSvxfs60 VRTSveki60 VRTSsfcpi60SP1 VRTSperl514
...
sub init_plat {
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        ...
        VRTSvxfs-common VRTSsfcpi60SP1 VRTSperl514 VRTSvlic32
    ) ];
    my $padv=$prod->padv();
    $prod->{fstab}='/etc/fstab';
    $padv->{cmd}{fstyp}='/opt/VRTS/bin/fstyp';
...
sub init_plat {
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        ...
        VRTSicsco VRTSvxfs60 VRTSsfcpi60SP1 VRTSperl514 VRTSvlic32
    ) ];
