...
sub encap_upgrade_precheck_sys {
    ...
    if ($sys->sunos()) {
        ...
        for my $vol (split(/\s+/m,$volumes)) {
            ...
            # e3333880: try to get bootdg minor number for RVG if above cmd fails
...
sub init_plat {
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        ...
        VRTSsfcpi604 VRTSperl514 VRTSperl.rte VRTSvlic32
    ) ];
...
sub init_plat {
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        ...
        VRTSjre VRTSsfcpi604 VRTSperl514 VRTSvlic32 VRTSwl
    ) ];
...
sub init_plat {
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        ...
        VRTSsfcpi604 VRTSperl514 VRTSvlic32
    ) ];
...
sub init_plat {
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        ...
        VRTSicsco VRTSvxvm60 VRTSjre15 VRTSjre VRTSsfcpi604 VRTSperl514
        VRTSvlic32
    ) ];
