...
package Proc::vcsmm62::Common;
@Proc::vcsmm62::Common::ISA = qw(Proc);
...
package Proc::vcsmm62::AIX;
@Proc::vcsmm62::AIX::ISA = qw(Proc::vcsmm62::Common);
...
package Proc::vcsmm62::HPUX;
@Proc::vcsmm62::HPUX::ISA = qw(Proc::vcsmm62::Common);
...
package Proc::vcsmm62::Linux;
@Proc::vcsmm62::Linux::ISA = qw(Proc::vcsmm62::Common);
sub init_plat {
    my $proc=shift;
...
sub check_sys {
    ...
    if ($state =~ /start/m) {
        ...
        $vcsmmconf = $sys->cmd("_cmd_gabconfig -a 2>/dev/null | _cmd_grep 'Port o'");
        return 1 if ($modid && $vcsmmconf && !EDR::cmdexit());
    }
    return 0;
}

package Proc::vcsmm62::SunOS;
@Proc::vcsmm62::SunOS::ISA = qw(Proc::vcsmm62::Common);
