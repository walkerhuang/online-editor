...
package Pkg::VRTSjaodm62::Common;
@Pkg::VRTSjaodm62::Common::ISA = qw(Pkg);
...
package Pkg::VRTSjaodm62::SunOS;
@Pkg::VRTSjaodm62::SunOS::ISA = qw(Pkg::VRTSjaodm62::Common);
...
sub init_padv {
    ...
    $pkg->{name}=Msg::new("Multi Language License Utilities")->{msg};
    return;
}
...
sub init_padv {
    ...
    $pkg->{name}=Msg::new("Japanese File System Language Kit")->{msg};
    return;
}
...
sub init_padv {
    ...
    $pkg->{name}=Msg::new("Japanese Volume Manager Language Kit")->{msg};
    return;
}
...
sub init_padv {
    ...
    $pkg->{pkg}='VRTSzhvm';
    $pkg->{basepkg}='VRTSvxvm';
    $pkg->{name}=Msg::new("Chinese Volume Manager Language Kit")->{msg};
    return;
}
...
# VRTSjaodm62
package Pkg::VRTSjaodm62::SolSparc;
@Pkg::VRTSjaodm62::SolSparc::ISA = qw(Pkg::VRTSjaodm62::SunOS);
