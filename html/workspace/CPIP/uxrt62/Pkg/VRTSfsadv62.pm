...
package Pkg::VRTSfsadv62::Common;
@Pkg::VRTSfsadv62::Common::ISA = qw(Pkg);
...
package Pkg::VRTSfsadv62::AIX;
@Pkg::VRTSfsadv62::AIX::ISA = qw(Pkg::VRTSfsadv62::Common);

package Pkg::VRTSfsadv62::HPUX;
@Pkg::VRTSfsadv62::HPUX::ISA = qw(Pkg::VRTSfsadv62::Common);

package Pkg::VRTSfsadv62::HPUX1131par;
@Pkg::VRTSfsadv62::HPUX1131par::ISA = qw(Pkg::VRTSfsadv62::HPUX);
...
package Pkg::VRTSfsadv62::Linux;
@Pkg::VRTSfsadv62::Linux::ISA = qw(Pkg::VRTSfsadv62::Common);

package Pkg::VRTSfsadv62::SunOS;
@Pkg::VRTSfsadv62::SunOS::ISA = qw(Pkg::VRTSfsadv62::Common);

package Pkg::VRTSfsadv62::RHEL5x8664;
@Pkg::VRTSfsadv62::RHEL5x8664::ISA = qw(Pkg::VRTSfsadv62::Linux);
...
package Pkg::VRTSfsadv62::RHEL6x8664;
@Pkg::VRTSfsadv62::RHEL6x8664::ISA = qw(Pkg::VRTSfsadv62::Linux);
...
sub init_padv {
    ...
    $pkg->{oslibs}{'RHEL6.5'}={
        "libacl.so.1()(64bit)"  =>  "libacl-2.2.49-6.el6.x86_64",
        "libacl.so.1(ACL_1.0)(64bit)"  =>  "libacl-2.2.49-6.el6.x86_64",
        "libcrypto.so.10()(64bit)"  =>  "openssl-1.0.1e-15.el6.x86_64",
        "libcrypt.so.1()(64bit)"  =>  "glibc-2.12-1.132.el6.x86_64",
        "libcrypt.so.1(GLIBC_2.2.5)(64bit)"  =>  "glibc-2.12-1.132.el6.x86_64",
        ...
        "libgcc_s.so.1()(64bit)"  =>  "libgcc-4.4.7-4.el6.x86_64",
        "libgcc_s.so.1(GCC_3.0)(64bit)"  =>  "libgcc-4.4.7-4.el6.x86_64",
        ...
        "librt.so.1()(64bit)"  =>  "glibc-2.12-1.132.el6.x86_64",
        "librt.so.1(GLIBC_2.2.5)(64bit)"  =>  "glibc-2.12-1.132.el6.x86_64",
        "libssl.so.10()(64bit)"  =>  "openssl-1.0.1e-15.el6.x86_64",
        "libstdc++.so.6()(64bit)"  =>  "libstdc++-4.4.7-4.el6.x86_64",
        "libstdc++.so.6(CXXABI_1.3)(64bit)"  =>  "libstdc++-4.4.7-4.el6.x86_64",
        "libstdc++.so.6(GLIBCXX_3.4.5)(64bit)"  =>  "libstdc++-4.4.7-4.el6.x86_64",
        "libstdc++.so.6(GLIBCXX_3.4)(64bit)"  =>  "libstdc++-4.4.7-4.el6.x86_64",
        "libz.so.1()(64bit)"  =>  "zlib-1.2.3-29.el6.x86_64",
        "rtld(GNU_HASH)"  =>  "glibc-2.12-1.132.el6.i686 glibc-2.12-1.132.el6.x86_64",
    };
    $pkg->{oslibs}{'RHEL6.6'}={
        "libacl.so.1()(64bit)"  =>  "libacl-2.2.49-6.el6.x86_64",
        "libacl.so.1(ACL_1.0)(64bit)"  =>  "libacl-2.2.49-6.el6.x86_64",
        "libcrypto.so.10()(64bit)"  =>  "openssl-1.0.1e-30.el6.x86_64",
        ...
        "libssl.so.10()(64bit)"  =>  "openssl-1.0.1e-30.el6.x86_64",
        "libstdc++.so.6()(64bit)"  =>  "libstdc++-4.4.7-11.el6.x86_64",
        "libstdc++.so.6(CXXABI_1.3)(64bit)"  =>  "libstdc++-4.4.7-11.el6.x86_64",
        "libstdc++.so.6(GLIBCXX_3.4.5)(64bit)"  =>  "libstdc++-4.4.7-11.el6.x86_64",
        "libstdc++.so.6(GLIBCXX_3.4)(64bit)"  =>  "libstdc++-4.4.7-11.el6.x86_64",
        "libz.so.1()(64bit)"  =>  "zlib-1.2.3-29.el6.x86_64",
...
package Pkg::VRTSfsadv62::RHEL7x8664;
@Pkg::VRTSfsadv62::RHEL7x8664::ISA = qw(Pkg::VRTSfsadv62::Linux);

sub init_padv {
    my $pkg=shift;
    $pkg->{oslibs}{'RHEL7.0'}={
        "libcrypt.so.1()(64bit)"  =>  "glibc-2.17-55.el7.x86_64",
        "libcrypt.so.1(GLIBC_2.2.5)(64bit)"  =>  "glibc-2.17-55.el7.x86_64",
        ...
        "librt.so.1()(64bit)"  =>  "glibc-2.17-55.el7.x86_64",
        "librt.so.1(GLIBC_2.2.5)(64bit)"  =>  "glibc-2.17-55.el7.x86_64",
        "libstdc++.so.6()(64bit)"  =>  "libstdc++-4.8.2-16.el7.x86_64",
        "libstdc++.so.6(CXXABI_1.3)(64bit)"  =>  "libstdc++-4.8.2-16.el7.x86_64",
        "libstdc++.so.6(GLIBCXX_3.4.5)(64bit)"  =>  "libstdc++-4.8.2-16.el7.x86_64",
        "libstdc++.so.6(GLIBCXX_3.4)(64bit)"  =>  "libstdc++-4.8.2-16.el7.x86_64",
...
package Pkg::VRTSfsadv62::OL6x8664;
@Pkg::VRTSfsadv62::OL6x8664::ISA = qw(Pkg::VRTSfsadv62::RHEL6x8664);

package Pkg::VRTSfsadv62::OL7x8664;
@Pkg::VRTSfsadv62::OL7x8664::ISA = qw(Pkg::VRTSfsadv62::RHEL7x8664);

package Pkg::VRTSfsadv62::SLES10x8664;
@Pkg::VRTSfsadv62::SLES10x8664::ISA = qw(Pkg::VRTSfsadv62::Linux);
...
package Pkg::VRTSfsadv62::SLES11x8664;
@Pkg::VRTSfsadv62::SLES11x8664::ISA = qw(Pkg::VRTSfsadv62::Linux);
