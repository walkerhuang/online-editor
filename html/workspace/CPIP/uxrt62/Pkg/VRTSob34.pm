...
sub init_padv {
    ...
    $pkg->{oslibs}{'RHEL6.6'}={
        ...
        "libc.so.6(GCC_3.0)"  =>  "glibc-2.12-1.149.el6.i686",
        ...
        "libc.so.6(GLIBC_2.3.3)"  =>  "glibc-2.12-1.149.el6.i686",
        "libc.so.6(GLIBC_2.3.4)"  =>  "glibc-2.12-1.149.el6.i686",
        ...
        "libpam.so.0"  =>  "pam-1.1.1-20.el6.i686",
...
package Pkg::VRTSob34::RHEL7x8664;
@Pkg::VRTSob34::RHEL7x8664::ISA = qw(Pkg::VRTSob34::Linux);
...
sub init_padv {
    ...
    $pkg->{oslibs}{'RHEL7.0'}={
        ...
        "libc.so.6(GCC_3.0)"  =>  "glibc-2.17-55.el7.i686",
        ...
        "libc.so.6(GLIBC_2.3.3)"  =>  "glibc-2.17-55.el7.i686",
        "libc.so.6(GLIBC_2.3.4)"  =>  "glibc-2.17-55.el7.i686",
        ...
        "libpam.so.0"  =>  "pam-1.1.8-9.el7.i686",
...
package Pkg::VRTSob34::OL6x8664;
@Pkg::VRTSob34::OL6x8664::ISA = qw(Pkg::VRTSob34::RHEL6x8664);

package Pkg::VRTSob34::OL7x8664;
@Pkg::VRTSob34::OL7x8664::ISA = qw(Pkg::VRTSob34::RHEL7x8664);
