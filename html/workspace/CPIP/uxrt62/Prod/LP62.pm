...
package Prod::LP62::Common;
@Prod::LP62::Common::ISA = qw(Prod);
...
package Prod::LP62::SunOS;
@Prod::LP62::SunOS::ISA = qw(Prod::LP62::Common);

package Prod::LP62::SolSparc;
@Prod::LP62::SolSparc::ISA = qw(Prod::LP62::SunOS);
...
sub init_padv {
    ...
    $prod->{allpkgs} = [ qw(VRTSmulic32 VRTSjacav60 VRTSjacs60 VRTSjacse60 VRTSjacsu60 VRTSjadba60 VRTSjafs60 VRTSjavm60 VRTSjadbe60 VRTSjaodm62 VRTSzhvm60) ];
...
sub getlangpkg {
    ...
    if ($prod->{lang} eq 'ja') {
        $prod->{allpkgs} = [ qw(VRTSmulic32 VRTSjacav60 VRTSjacs60 VRTSjacse60 VRTSjacsu60 VRTSjadba60 VRTSjafs60 VRTSjavm60 VRTSjadbe60 VRTSjaodm62) ];
