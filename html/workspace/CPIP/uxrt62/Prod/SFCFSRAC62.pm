...
package Prod::SFCFSRAC62::Common;
@Prod::SFCFSRAC62::Common::ISA = qw(Prod);
...
sub init_common {
    ...
    $prod->{eula}='EULA_SFCFS_Oracle_Rac_Ux_6.2.pdf';
...
package Prod::SFCFSRAC62::Linux;
@Prod::SFCFSRAC62::Linux::ISA = qw(Prod::SFCFSRAC62::Common);

sub init_plat {
    my $prod=shift;
    $prod->{allpkgs}=[ qw(VRTSob34 VRTSglm62 VRTScavf62 VRTSgms62 VRTSodm62 VRTSvcsea62) ];
    $prod->{minpkgs}=[ qw(VRTSglm62 VRTScavf62 VRTSgms62 VRTSodm62 VRTSvcsea62) ];
    $prod->{recpkgs}=[ qw(VRTSglm62 VRTScavf62 VRTSgms62 VRTSodm62 VRTSvcsea62) ];
    $prod->{proddir}='storage_foundation_cluster_file_system_for_oracle_rac';
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        VRTScsocw VRTSvcsea62 VRTScfsdc VRTSodm62 VRTSodm-platform
        ...
        VRTSvxfen62 VRTSgab62 VRTSllt62 VRTSfsmnd VRTSfssdk62
