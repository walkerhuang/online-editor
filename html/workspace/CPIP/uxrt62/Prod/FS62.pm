...
package Prod::FS62::Common;
@Prod::FS62::Common::ISA = qw(Prod);
...
package Prod::FS62::AIX;
@Prod::FS62::AIX::ISA = qw(Prod::FS62::Common);

sub init_plat {
    my $prod=shift;
    my $padv=$prod->padv();
    $prod->{allpkgs}=[ qw(VRTSob34 VRTSveki62 VRTSvxfs62 VRTSfsadv62 VRTSfssdk62 VRTSsfmh61) ];
    $prod->{minpkgs}=[ qw(VRTSveki62 VRTSvxfs62 VRTSfsadv62) ];
    $prod->{recpkgs}=[ qw(VRTSob34 VRTSveki62 VRTSvxfs62 VRTSfsadv62 VRTSsfmh61) ];
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        VRTSfppm VRTSap VRTStep VRTSsfmh61 VRTSfsmnd VRTSfssdk62
        VRTSfsadv62 VRTSfsdoc VRTSfsman VRTScpi.rte VRTSvsvc SYMClma VRTSspt62
        VRTSaa VRTSmh VRTSccg VRTSobgui VRTSfspro VRTSdsa VRTSob34
        VRTSobc33 VRTSat50 VRTSat.server VRTSat.client VRTSsmf
        VRTSpbx VRTSicsco VRTSvxfs62 VRTSveki62 VRTSsfcpi62 VRTSvlic32
...
sub mounted_vxfs_sys {
    ...
    $ret = $sys->cmd("_cmd_mount | _cmd_awk '{if(\$3 == \"vxfs\"){print \$2}}'");
    @mps = split /\s+/m, $ret;
    return \@mps;
}
...
package Prod::FS62::HPUX;
@Prod::FS62::HPUX::ISA = qw(Prod::FS62::Common);

sub init_plat {
    my $prod=shift;
    $prod->{allpkgs}=[ qw(VRTSob34 VRTSvxfs62 VRTSfssdk62 VRTSsfmh61)];
    $prod->{minpkgs}=[ qw(VRTSvxfs62) ];
    $prod->{recpkgs}=[ qw(VRTSob34 VRTSvxfs62 VRTSsfmh61) ];
    $prod->{proddir}='storage_foundation';
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        VRTStep VRTSap VRTSsfmh61 VRTSfsmnd VRTSdcli VRTSfssdk62
        VRTSfsadv62 VRTSfsdoc VRTSfsman VRTScpi VRTSvsvc SYMClma VRTSspt62
        VRTSaa VRTSmh VRTSccg VRTSobgui VRTSfspro VRTSdsa VRTSob34
        VRTSobc33 VRTSat50 VRTSsmf VRTSpbx VRTSicsco VRTSvxfs62
...
package Prod::FS62::HPUX1131ia64;
@Prod::FS62::HPUX1131ia64::ISA = qw(Prod::FS62::HPUX);

sub init_padv {
    my $prod=shift;
    $prod->{allpkgs}=[ qw(VRTSob34 VRTSvxfs62 VRTSfsadv62 VRTSfssdk62 VRTSsfmh61)];
    $prod->{minpkgs}=[ qw(VRTSvxfs62 VRTSfsadv62) ];
    $prod->{recpkgs}=[ qw(VRTSob34 VRTSvxfs62 VRTSfsadv62 VRTSsfmh61) ];
    return;
}
...
package Prod::FS62::Linux;
@Prod::FS62::Linux::ISA = qw(Prod::FS62::Common);
...
sub init_plat {
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        VRTSfsnbl VRTSfppm VRTSap VRTStep VRTSsfmh61 VRTSdcli
        VRTSfsmnd VRTSfssdk62 VRTSfsadv62 VRTSfsdoc VRTSfsman VRTScpi VRTSvsvc
        SYMClma VRTSspt62 VRTSaa VRTSmh VRTSccg VRTSobgui VRTSfspro
        VRTSdsa VRTSob34 VRTSobc33 VRTSat50 VRTSatClient50
        VRTSsmf VRTSpbx VRTSicsco VRTSvxfs62 VRTSvxfs-platform
        VRTSvxfs-common VRTSsfcpi62 VRTSvlic32 VRTSperl516 
    ) ];
    my $padv=$prod->padv();
    $prod->{fstab}='/etc/fstab';
    $padv->{cmd}{fstyp}='/opt/VRTS/bin/fstyp';
...
package Prod::FS62::RHEL7x8664;
@Prod::FS62::RHEL7x8664::ISA = qw(Prod::FS62::Linux);
...
sub init_padv {
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        ...
        VRTSdsa VRTSob34 VRTSobc33 VRTSat50 VRTSatClient50
        VRTSsmf VRTSpbx VRTSicsco VRTSvxfs62 VRTSvxfs-platform
        VRTSvxfs-common VRTSveki62 VRTSsfcpi62 VRTSvlic32 VRTSperl516 
    ) ];

    return 1;
}

package Prod::FS62::OL7x8664;
@Prod::FS62::OL7x8664::ISA = qw(Prod::FS62::RHEL7x8664);

package Prod::FS62::SunOS;
@Prod::FS62::SunOS::ISA = qw(Prod::FS62::Common);
...
sub init_plat {
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        ...
        VRTSicsco VRTSvxfs62 VRTSsfcpi62 VRTSvlic32 VRTSperl516
    ) ];
...
package Prod::FS62::SolSparc;
@Prod::FS62::SolSparc::ISA = qw(Prod::FS62::SunOS);
...
package Prod::FS62::Sol11sparc;
@Prod::FS62::Sol11sparc::ISA = qw(Prod::FS62::SunOS);

sub init_padv {
    my $prod=shift;
    $prod->{upgradevers}=[qw(6.0.10 6.1 6.2)];
    $prod->{zru_releases}=[qw(6.0.10 6.1 6.2)];
    $prod->{allpkgs}=[ qw(VRTSvxfs62 VRTSfsadv62 VRTSfssdk62 VRTSsfmh61) ];
    $prod->{minpkgs}=[ qw(VRTSvxfs62 VRTSfsadv62) ];
    $prod->{recpkgs}=[ qw(VRTSvxfs62 VRTSfsadv62 VRTSsfmh61) ];
...
package Prod::FS62::Solx64;
@Prod::FS62::Solx64::ISA = qw(Prod::FS62::SunOS);
...
package Prod::FS62::Sol11x64;
@Prod::FS62::Sol11x64::ISA = qw(Prod::FS62::SunOS);

sub init_padv {
    my $prod=shift;
    $prod->{upgradevers}=[qw(6.0.10)];
    $prod->{zru_releases}=[qw(6.0.10)];
    $prod->{allpkgs}=[ qw(VRTSvxfs62 VRTSfssdk62 VRTSsfmh61) ];
    $prod->{minpkgs}=[ qw(VRTSvxfs62) ];
    $prod->{recpkgs}=[ qw(VRTSvxfs62 VRTSsfmh61) ];
