...
package Prod::SFSYBASECE61::Common;
@Prod::SFSYBASECE61::Common::ISA = qw(Prod::SFCFSHA61::Common);
    ...
    if ($ase_resource) {
         for my $node ( @{CPIC::get("systems") } ) {
            ...
            if ((EDR::cmdexit() == 0) && ($running + 0) > 0) {
                my $sysname = Prod::VCS61::Common::transform_system_name($node->{sys});
...
sub bring_sybase_online {
    ...
    foreach my $sys1 (@{CPIC::get("systems")}){
        my $sysname = Prod::VCS61::Common::transform_system_name($sys1->{sys});
...
sub add_service_group {
    ...
    for my $nsys ( 0 .. $#{$sysobjs} ) {
        my $sysname = Prod::VCS61::Common::transform_system_name(@{$sysobjs}[$nsys]->{sys});
        $syss    .= "$sysname ";
...
sub addnode_ask_sybase_config {
    ...
    $system = Prod::VCS61::Common::transform_system_name($firstnode->{sys});
...
sub addnode_ask_sybase_server {
    ...
    for my $sysi (@{$cfg->{newnodes}}) {
        $system = Prod::VCS61::Common::transform_system_name($sysi);
        while (1){
...
package Prod::SFSYBASECE61::AIX;
@Prod::SFSYBASECE61::AIX::ISA = qw(Prod::SFSYBASECE61::Common);
...
sub init_plat {
    ...
    $prod->{upgradevers}=[qw(4.0.4 5.0 5.1 6.0 6.1)];
...
package Prod::SFSYBASECE61::HPUX;
@Prod::SFSYBASECE61::HPUX::ISA = qw(Prod::SFSYBASECE61::Common);
...
package Prod::SFSYBASECE61::Linux;
@Prod::SFSYBASECE61::Linux::ISA = qw(Prod::SFSYBASECE61::Common);
...
sub init_plat {
    ...
    $prod->{recpkgs}=[ qw(VRTSob34 VRTSglm61 VRTScavf61 VRTSgms61 VRTSodm61) ];
    $prod->{proddir}='storage_foundation_for_sybase_ce';
    $prod->{upgradevers}=[qw(4.1.40 5.0 5.1 6.0 6.1)];
    ...
    $prod->{obsoleted_previous_releases_pkgs} = [ qw(
        VRTScsocw VRTSvbs61 VRTSvcsea61 VRTScfsdc VRTSodm61 VRTSodm-platform
...
package Prod::SFSYBASECE61::RHEL5x8664;
@Prod::SFSYBASECE61::RHEL5x8664::ISA = qw(Prod::SFSYBASECE61::Linux);

package Prod::SFSYBASECE61::RHEL6x8664;
@Prod::SFSYBASECE61::RHEL6x8664::ISA = qw(Prod::SFSYBASECE61::Linux);

package Prod::SFSYBASECE61::SunOS;
@Prod::SFSYBASECE61::SunOS::ISA = qw(Prod::SFSYBASECE61::Common);
...
package Prod::SFSYBASECE61::SolSparc;
@Prod::SFSYBASECE61::SolSparc::ISA = qw(Prod::SFSYBASECE61::SunOS);

sub init_padv {
    my $prod=shift;
    $prod->{upgradevers}=[qw(4.1.2 5.0 5.1 6.0 6.1)];
    $prod->{zru_releases}=[qw(5.0.3 5.1 6.0 6.1)];
    return;
}

package Prod::SFSYBASECE61::Sol11sparc;
@Prod::SFSYBASECE61::Sol11sparc::ISA = qw(Prod::SFSYBASECE61::SunOS);
...
package Prod::SFSYBASECE61::Solx64;
@Prod::SFSYBASECE61::Solx64::ISA = qw(Prod::SFSYBASECE61::SunOS);
...
package Prod::SFSYBASECE61::Sol11x64;
@Prod::SFSYBASECE61::Sol11x64::ISA = qw(Prod::SFSYBASECE61::SunOS);
