...
sub init_args {
    ...
    $rel->{arguments} = $arguments = {
        ...
        'args_opt' => [ qw(security securityonenode securitytrust fips addnode fencing configcps disable_dmp_native_support
                           vxunroot rolling_upgrade rollingupgrade_phase1 rollingupgrade_phase2 pseudo_hotfix) ],
...
sub init_padv {
    ...
    $rel->{pkgsetprods}=EDRu::arrdel($rel->{pkgsetprods}, qw(SFSYBASECE61));
    $rel->{menuprods}=EDRu::arrdel($rel->{menuprods}, qw(SFSYBASECE61));
    $rel->{platreqs} = ['RHEL6 U3 (2.6.32-279.el6)', 'RHEL6 U4 (2.6.32-358.el6)',
                        'OEL6 U3 (2.6.32-279.el6)','OEL6 U4 (2.6.32-358.el6)'];
