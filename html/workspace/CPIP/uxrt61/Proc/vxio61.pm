...
package Proc::vxio61::Common;
@Proc::vxio61::Common::ISA = qw(Proc);
...
package Proc::vxio61::AIX;
@Proc::vxio61::AIX::ISA = qw(Proc::vxio61::Common);

package Proc::vxio61::HPUX;
@Proc::vxio61::HPUX::ISA = qw(Proc::vxio61::Common);

package Proc::vxio61::Linux;
@Proc::vxio61::Linux::ISA = qw(Proc::vxio61::Common);
...
package Proc::vxio61::SunOS;
@Proc::vxio61::SunOS::ISA = qw(Proc::vxio61::Common);
...
sub stop_sys {
    ...
    $sys->cmd("_cmd_rmdrv $proc->{proc} 2>/dev/null");
    return 1;
}
...
package Proc::vxio61::Sol11sparc;
@Proc::vxio61::Sol11sparc::ISA = qw(Proc::vxio61::SunOS);
