...
sub poststart_configure_sys {
    my ($prod, $sys) = @_;
    my $fencing_cmd='/opt/VRTS/install/installsfrac -fencing';
...
sub check_fencing_sys {
    ...
    my $is_cps_fence= $localsys->cmd(" _cmd_vxfenadm -d | _cmd_grep 'Fencing Mechanism' | _cmd_grep 'cps' ");
