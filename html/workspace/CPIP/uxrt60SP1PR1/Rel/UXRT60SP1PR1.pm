...
package Rel::UXRT60SP1PR1::Common;
@Rel::UXRT60SP1PR1::Common::ISA = qw(Rel);
...
sub init_common {
    ...
    $rel->{prods}=[ qw(VCS60) ];
    $rel->{pkgsetprods}=[ qw(VCS60) ];
    #$rel->{menuprods}=EDRu::arrdel($rel->{prods}, qw(FS60 VM60 SFCFSRAC60));
    $rel->{menuprods}=[qw(VCS60)];
    $rel->{upgradeprods} = [ qw(VCS60) ];
    $rel->{allpkgs}=[ qw(VRTSperl514 VRTSvlic32 VRTSsfcpi60SP1PR1 VRTSspt60) ];
    $rel->{minpkgs}=[ qw(VRTSperl514 VRTSvlic32 VRTSsfcpi60SP1PR1) ];
    $rel->{recpkgs}=[ qw(VRTSperl514 VRTSvlic32 VRTSsfcpi60SP1PR1 VRTSspt60) ];
    $rel->{cpipkg}='VRTSsfcpi60SP1PR1';
    ...
    $rel->{installonupgradepkgs}=[ qw(VRTSsfcpi60SP1PR1) ];
...
sub init_args {
    ...
    $rel->{arguments} = $arguments = {
        ...
        'jumpstart' => {
            ...
            'handler' => \&Rel::UXRT60SP1PR1::Common::process_jumpstart_arg,
        },
        'flash_archive' => {
            ...
            'handler' => \&Rel::UXRT60SP1PR1::Common::process_flash_archive_arg,
        },
        'ai' => {
            ...
            'handler' => \&Rel::UXRT60SP1PR1::Common::process_ai_arg,
        },
        'kickstart' => {
            ...
            'handler' => \&Rel::UXRT60SP1PR1::Common::process_kickstart_arg,
        },
        'yumgroupxml' => {
            ...
            'handler' => \&Rel::UXRT60SP1PR1::Common::process_yumgroupxml_arg,
        },
        'nim' => {
            ...
            'handler' => \&Rel::UXRT60SP1PR1::Common::process_nim_arg,
        },

        # UXRT60SP1PR1 option args
        'ignite' => {
            ...
            'handler' => \&Rel::UXRT60SP1PR1::Common::process_ignite_arg,
        },
        ...
        'security' => {
            ...
            'handler' => \&Rel::UXRT60SP1PR1::Common::process_security_arg,
        },
        'securityonenode' => {
        ...
        'fencing' => {
            ...
            'handler' => \&Rel::UXRT60SP1PR1::Common::process_fencing_arg,
        },
        'configcps' => {
        ...
        'addnode' => {
            ...
            'handler' => \&Rel::UXRT60SP1PR1::Common::process_addnode_arg,
        },
        'upgrade_kernelpkgs' => {
            'description' => Msg::new("The -upgrade_kernelpkgs option has been renamed to -rollingupgrade_phase1"),
            'handler' => \&Rel::UXRT60SP1PR1::Common::process_ru_arg,
        },
...
sub ask_usr_ru1 {
    ...
    $msg=Msg::new("\nIt is recommended to perform rolling upgrade phase 1 on the system(s) $showlist for minimal downtime.");
    $msg->bold;
    $webmsg .= $msg->{msg};
    $webmsg =~ s/\n/\\n/g;
...
sub ask_usr_ru1ru2 {
    ...
    Cfg::unset_opt("upgrade_nonkernelpkgs");
    # set ru_running_list & ru_idle_list for $rel
    $rel->{ru_running_list} = $inputlist || $sclist;
...
sub ignite {
    ...
    if (EDR::cmdexit()) {
        ...
        # add post_load_cmd = "/opt/VRTS/install/bin/UXRT60SP1PR1/add_install_scripts" in core_media_cfg
        ...
        for my $line (@conts) {
            if ($line=~/sd_software_list/) {
                $filecont.="    ";
                $filecont.="post_load_cmd = \"/opt/VRTS/install/bin/UXRT60SP1PR1/add_install_scripts\"\n";
            }
            $filecont.=$line."\n";
        }
...
@Rel::UXRT60SP1PR1::AIX::ISA = qw(Rel::UXRT60SP1PR1::Common);
...
@Rel::UXRT60SP1PR1::HPUX::ISA = qw(Rel::UXRT60SP1PR1::Common);
...
@Rel::UXRT60SP1PR1::HPUX1131::ISA = qw(Rel::UXRT60SP1PR1::HPUX);
...
@Rel::UXRT60SP1PR1::Linux::ISA = qw(Rel::UXRT60SP1PR1::Common);
...
@Rel::UXRT60SP1PR1::RHEL5x8664::ISA = qw(Rel::UXRT60SP1PR1::Linux);
...
@Rel::UXRT60SP1PR1::RHEL5ppc64::ISA = qw(Rel::UXRT60SP1PR1::Linux);
...
@Rel::UXRT60SP1PR1::RHEL6x8664::ISA = qw(Rel::UXRT60SP1PR1::Linux);
...
@Rel::UXRT60SP1PR1::RHEL6ppc64::ISA = qw(Rel::UXRT60SP1PR1::Linux);
...
@Rel::UXRT60SP1PR1::SLES10x8664::ISA = qw(Rel::UXRT60SP1PR1::Linux);
...
@Rel::UXRT60SP1PR1::SLES10ppc64::ISA = qw(Rel::UXRT60SP1PR1::Linux);
...
@Rel::UXRT60SP1PR1::SLES11x8664::ISA = qw(Rel::UXRT60SP1PR1::Linux);
...
@Rel::UXRT60SP1PR1::SLES11ppc64::ISA = qw(Rel::UXRT60SP1PR1::Linux);
...
@Rel::UXRT60SP1PR1::SunOS::ISA = qw(Rel::UXRT60SP1PR1::Common);
...
@Rel::UXRT60SP1PR1::SolSparc::ISA = qw(Rel::UXRT60SP1PR1::SunOS);
...
@Rel::UXRT60SP1PR1::Solx64::ISA = qw(Rel::UXRT60SP1PR1::SunOS);
...
@Rel::UXRT60SP1PR1::Sol11sparc::ISA = qw(Rel::UXRT60SP1PR1::SunOS);
...
sub init_padv {
    ...
    my $msg = Msg::new("Solaris 11 (64 bit only)");
    $rel->{platreqs}=[ $msg->{msg} ];
...
@Rel::UXRT60SP1PR1::Sol11x64::ISA = qw(Rel::UXRT60SP1PR1::Sol11sparc);
