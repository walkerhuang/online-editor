...
package Pkg::VRTSsfcpi60SP1PR1::Common;
@Pkg::VRTSsfcpi60SP1PR1::Common::ISA = qw(Pkg);

sub init_common {
    my $pkg=shift;
    $pkg->{pkg}='VRTSsfcpi60SP1PR1';
...
sub postinstall_sys {
    ...
    my $scriptfile="$rootpath/opt/VRTS/install/bin/UXRT60SP1PR1/add_install_scripts";
...
package Pkg::VRTSsfcpi60SP1PR1::AIX;
@Pkg::VRTSsfcpi60SP1PR1::AIX::ISA = qw(Pkg::VRTSsfcpi60SP1PR1::Common);

package Pkg::VRTSsfcpi60SP1PR1::HPUX;
@Pkg::VRTSsfcpi60SP1PR1::HPUX::ISA = qw(Pkg::VRTSsfcpi60SP1PR1::Common);

package Pkg::VRTSsfcpi60SP1PR1::Linux;
@Pkg::VRTSsfcpi60SP1PR1::Linux::ISA = qw(Pkg::VRTSsfcpi60SP1PR1::Common);

package Pkg::VRTSsfcpi60SP1PR1::SunOS;
@Pkg::VRTSsfcpi60SP1PR1::SunOS::ISA = qw(Pkg::VRTSsfcpi60SP1PR1::Common);
