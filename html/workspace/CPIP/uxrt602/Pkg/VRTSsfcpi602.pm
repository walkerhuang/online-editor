...
package Pkg::VRTSsfcpi602::Common;
@Pkg::VRTSsfcpi602::Common::ISA = qw(Pkg);

sub init_common {
    my $pkg=shift;
    $pkg->{pkg}='VRTSsfcpi602';
...
sub postinstall_sys {
    ...
    my $scriptfile="$rootpath/opt/VRTS/install/bin/UXRT602/add_install_scripts";
...
package Pkg::VRTSsfcpi602::AIX;
@Pkg::VRTSsfcpi602::AIX::ISA = qw(Pkg::VRTSsfcpi602::Common);

package Pkg::VRTSsfcpi602::HPUX;
@Pkg::VRTSsfcpi602::HPUX::ISA = qw(Pkg::VRTSsfcpi602::Common);

package Pkg::VRTSsfcpi602::Linux;
@Pkg::VRTSsfcpi602::Linux::ISA = qw(Pkg::VRTSsfcpi602::Common);

package Pkg::VRTSsfcpi602::SunOS;
@Pkg::VRTSsfcpi602::SunOS::ISA = qw(Pkg::VRTSsfcpi602::Common);
