...
sub check_prods_install_status_sys {
    ...
    for my $prod (sort keys %{$sys->{iprod}}) {
        ...
        if ($sys->linux() && $mprpvers eq '6.0.1') {
            if ($prod eq "sfha" or $prod eq "vcs") {
                if ($sys->{pkgvers}{'VRTSvcsag'} == '6.0.110.000'){
                    $majorvers = $mpvers = $mprpvers = '6.0.2';
                }      
            }
        }
        ...
        #move back to 6.0.1
        if ($sys->{iprod}{$prod}{mprpvers} == '6.0.2') {
            $sys->{iprod}{$prod}{mjvers} = $sys->{iprod}{$prod}{mpvers} = $sys->{iprod}{$prod}{mprpvers} = '6.0.2';
        }
    ...
    $rel->{rel} = {
        ...
        '6.0.1' => {
            ...
            'prod' => {
                'dmp' => {
                    'name'  => 'Veritas Dynamic Multipathing',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi602 VRTSvlic VRTSvxvm)],
                    'opkgs' => [qw(VRTSsfmh VRTSspt)],
                },
                'fs' => {
                    'name'  => 'Veritas File System',
                    'rpkgs' => [qw(VRTSfsadv VRTSperl VRTSsfcpi602 VRTSvlic VRTSvxfs)],
                    'opkgs' => [qw(VRTSfssdk VRTSob VRTSsfmh VRTSspt)],
                },
                'sf' => {
                    'name'  => 'Veritas Storage Foundation',
                    'rpkgs' => [qw(VRTSaslapm VRTSfsadv VRTSperl VRTSsfcpi602 VRTSvlic VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTSdbed VRTSfssdk VRTSob VRTSodm VRTSsfmh VRTSspt)],
                },
                'sfcfsha' => {
                    'name'  => 'Veritas Storage Foundation for Cluster File System/HA',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSfsadv VRTSgab VRTSglm VRTSllt VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSgms VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability',
                ...
                'sfrac' => {
                    'name'  => 'Veritas Storage Foundation for Oracle RAC',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSdbac VRTSdbed VRTSfsadv VRTSgab VRTSglm VRTSgms VRTSllt VRTSodm VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSvcsea VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSfssdk VRTSob VRTSsfmh VRTSspt VRTSvbs)],
                },
                'sfsybasece' => {
                    'name'  => 'Veritas Storage Foundation for Sybase ASE CE',
                ...
                'svs' => {
                    'name'  => 'Symantec VirtualStore',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSfsadv VRTSgab VRTSglm VRTSllt VRTSperl VRTSsfcpi602 VRTSsfmh VRTSsvs VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSgms VRTSob VRTSodm VRTSspt VRTSvbs VRTSvcsea)],
                },
                'vcs' => {
                    'name'  => 'Veritas Cluster Server',
...
package Rel::UXRT602::Sol11sparc;
    ...
    $rel->{rel} = {
        ...
        '6.0.1' => {
            ...
            'prod' => {
                ...
                'fs' => {
                    'name'  => 'Veritas File System',
                    'rpkgs' => [qw(VRTSperl VRTSsfcpi602 VRTSvlic VRTSvxfs)],
                    'opkgs' => [qw(VRTSfssdk VRTSob VRTSsfmh VRTSspt)],
                },
                'sf' => {
                    'name'  => 'Veritas Storage Foundation',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi602 VRTSvlic VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTSdbed VRTSfssdk VRTSob VRTSodm VRTSsfmh VRTSspt)],
                },
                'sfcfsha' => {
                    'name'  => 'Veritas Storage Foundation for Cluster File System/HA',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSgab VRTSglm VRTSllt VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSgms VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSgab VRTSllt VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'sfrac' => {
                    'name'  => 'Veritas Storage Foundation for Oracle RAC',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSdbac VRTSdbed VRTSgab VRTSglm VRTSgms VRTSllt VRTSodm VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSvcsea VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSfssdk VRTSob VRTSsfmh VRTSspt VRTSvbs)],
                },
                'svs' => {
                    'name'  => 'Symantec VirtualStore',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSgab VRTSglm VRTSllt VRTSperl VRTSsfcpi602 VRTSsfmh VRTSsvs VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSgms VRTSob VRTSodm VRTSspt VRTSvbs VRTSvcsea)],
                },
                'vcs' => {
                    'name'  => 'Veritas Cluster Server',
    ...
    $rel->{rel} = {
        ...
        '6.0.1' => {
            ...
            'prod' => {
                'fs' => {
                    'name'  => 'Veritas File System',
                    'rpkgs' => [qw(VRTSfsadv VRTSperl VRTSsfcpi602 VRTSveki VRTSvlic VRTSvxfs)],
                    'opkgs' => [qw(VRTSfssdk VRTSob VRTSsfmh VRTSspt)],
                },
                'sf' => {
                    'name'  => 'Veritas Storage Foundation',
                    'rpkgs' => [qw(VRTSaslapm VRTSfsadv VRTSperl VRTSsfcpi602 VRTSveki VRTSvlic VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTSdbed VRTSfssdk VRTSob VRTSodm VRTSsfmh VRTSspt)],
                },
                'sfcfsha' => {
                    'name'  => 'Veritas Storage Foundation for Cluster File System/HA',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSfsadv VRTSgab VRTSglm VRTSllt VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSveki VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSgms VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSfsadv VRTSgab VRTSllt VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSveki VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'sfrac' => {
                    'name'  => 'Veritas Storage Foundation for Oracle RAC',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTScavf VRTSdbac VRTSdbed VRTSfsadv VRTSgab VRTSglm VRTSgms VRTSllt VRTSodm VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSvcsea VRTSveki VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSfssdk VRTSob VRTSsfmh VRTSspt VRTSvbs)],
                },
                'vcs' => {
                    'name'  => 'Veritas Cluster Server',
                    'rpkgs' => [qw(VRTSamf VRTSgab VRTSllt VRTSperl VRTSsfcpi602 VRTSvcs VRTSvcsag VRTSveki VRTSvlic VRTSvxfen)],
                    'opkgs' => [qw(VRTScps VRTSsfmh VRTSspt VRTSvbs VRTSvcsea)],
                },
                'vm' => {
                    'name'  => 'Veritas Volume Manager',
                    'rpkgs' => [qw(VRTSaslapm VRTSperl VRTSsfcpi602 VRTSveki VRTSvlic VRTSvxvm)],
                    'opkgs' => [qw(VRTSob VRTSsfmh VRTSspt)],
                },
            },
            #_END_AIX_6.0_PRODS_PKGS_DEF_
...
package Rel::UXRT602::RHEL4x8664;
...
package Rel::UXRT602::RHEL5ppc64;
...
package Rel::UXRT602::RHEL6ppc64;
...
package Rel::UXRT602::SLES9x8664;
...
package Rel::UXRT602::SLES10ppc64;
...
package Rel::UXRT602::SLES11ppc64;
