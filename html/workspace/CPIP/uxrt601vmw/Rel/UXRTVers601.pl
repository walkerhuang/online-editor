...
sub check_prods_install_status_sys {
    ...
    for my $prod (sort keys %{$sys->{iprod}}) {
        ...
        # this code is especially for vcs or sfha on linux for VMware
        if ($sys->linux() && $mprpvers eq '6.0.1') {
            if ($prod eq "sfha" or $prod eq "vcs") {
                if ($sys->{pkgvers}{'VRTSvcsag'} == '6.0.110.000'){
                    $majorvers = $mpvers = $mprpvers = '6.0.1vmw';
                }      
            }
        }
        ...
        #move back to 6.0.1
        if ($sys->{iprod}{$prod}{mprpvers} == '6.0.1vmw') {
            $sys->{iprod}{$prod}{mjvers} = $sys->{iprod}{$prod}{mpvers} = $sys->{iprod}{$prod}{mprpvers} = '6.0.1';
        }
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '6.0.1vmw' => {
            #_START_RHEL5x8664_6.0.1vmw_PRODS_PKGS_DEF_
            'prod' => {
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability For VMware',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSfsadv VRTSgab VRTSllt VRTSperl VRTSsfcpi601vmw VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
                    'opkgs' => [qw(VRTScps VRTSdbed VRTSfssdk VRTSlvmconv VRTSob VRTSodm VRTSsfmh VRTSspt VRTSvbs VRTSvcsdr VRTSvcseai VRTSvcsvmw VRTSacclib VRTSmq VRTSsapnw04)],
                },
                'vcs' => {
                    'name'  => 'Veritas Cluster Server For VMware',
                    'rpkgs' => [qw(VRTSamf VRTSgab VRTSllt VRTSperl VRTSsfcpi601vmw VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen)],
                    'opkgs' => [qw(VRTScps VRTSsfmh VRTSspt VRTSvbs VRTSvcsdr VRTSvcsea VRTSvcsvmw VRTSacclib VRTSmq VRTSsapnw04)],
                },
            },
            #_END_RHEL5x8664_6.0.1vmw_PRODS_PKGS_DEF_
        },
    };
    return;
}
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '6.0.1vmw' => {
            #_START_RHEL6x8664_6.0.1vmw_PRODS_PKGS_DEF_
            'prod' => {
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability For VMware',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSfsadv VRTSgab VRTSllt VRTSperl VRTSsfcpi601vmw VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
            ...
            #_END_RHEL6x8664_6.0.1vmw_PRODS_PKGS_DEF_
        },
    };
    return;
}
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '6.0.1vmw' => {
            #_START_SLES10x8664_6.0.1vmw_PRODS_PKGS_DEF_
            'prod' => {
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability For VMware',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSfsadv VRTSgab VRTSllt VRTSperl VRTSsfcpi601vmw VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
            ...
            #_END_SLES10x8664_6.0.1vmw_PRODS_PKGS_DEF_
        },
    };
    return;
}
...
sub init_releasematrix {
    ...
    $rel->{rel} = {
        ...
        '6.0.1vmw' => {
            #_START_SLES11x8664_6.0.1vmw_PRODS_PKGS_DEF_
            'prod' => {
                'sfha' => {
                    'name'  => 'Veritas Storage Foundation and High Availability For VMware',
                    'rpkgs' => [qw(VRTSamf VRTSaslapm VRTSfsadv VRTSgab VRTSllt VRTSperl VRTSsfcpi601vmw VRTSvcs VRTSvcsag VRTSvlic VRTSvxfen VRTSvxfs VRTSvxvm)],
            ...
            #_END_SLES11x8664_6.0.1vmw_PRODS_PKGS_DEF_
        },
    };
    return;
}
