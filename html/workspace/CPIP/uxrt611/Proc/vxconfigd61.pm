...
package Proc::vxconfigd61::Common;
@Proc::vxconfigd61::Common::ISA = qw(Proc);
...
sub start_sys {
    ...
    if( (! $sys->exists($prod->{mkdbfile})) && ($sys->exists($prod->{volbootfile}))) {
        ...
        Msg::log("vxconfigd status: $voldmode");
        return 1;
    }
...
package Proc::vxconfigd61::AIX;
@Proc::vxconfigd61::AIX::ISA = qw(Proc::vxconfigd61::Common);
...
package Proc::vxconfigd61::HPUX;
@Proc::vxconfigd61::HPUX::ISA = qw(Proc::vxconfigd61::Common);
...
package Proc::vxconfigd61::Linux;
@Proc::vxconfigd61::Linux::ISA = qw(Proc::vxconfigd61::Common);
...
package Proc::vxconfigd61::SunOS;
@Proc::vxconfigd61::SunOS::ISA = qw(Proc::vxconfigd61::Common);
...
package Proc::vxconfigd61::Sol11sparc;
@Proc::vxconfigd61::Sol11sparc::ISA = qw(Proc::vxconfigd61::SunOS);
...
package Proc::vxconfigd61::Sol11x64;
@Proc::vxconfigd61::Sol11x64::ISA = qw(Proc::vxconfigd61::Sol11sparc);
