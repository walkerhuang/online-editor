...
package Pkg::VRTSveki61::Common;
@Pkg::VRTSveki61::Common::ISA = qw(Pkg);
...
package Pkg::VRTSveki61::AIX;
@Pkg::VRTSveki61::AIX::ISA = qw(Pkg::VRTSveki61::Common);
...
sub preinstall_sys {
    ...
    my @procs=qw(vxgms61 vxglm61 gab61 llt61);
    my $cpic=Obj::cpic();
    if(Cfg::opt("upgrade_kernelpkgs")){
        for my $proc(@procs){
